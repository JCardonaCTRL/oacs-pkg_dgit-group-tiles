...
set sql_search_filter ""
set field_list  [list package_name package_key]
...
set data_json_list ""
set field_list [list tile_id version_id package_name package_key num_of_groups]
db_foreach selected_rows_to_display "" {
    ...
    lappend field_json  [ctrl::json::construct_record [list [list "tile_ref" $tile_ref]]]
    ...
    append actions "<button type='button' \
                            ...
                            data-destination='${package_url}admin/group/modal/group-add?[export_vars {tile_id}]'>Manage Groups</button>"
